        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: auto; min-height: 500px;">
                    @if(@$parentData)
                        {{ Form::model(@$parentData, array('route' => array('convictnotarrestinfo.update', @$parentData->id), 'method' => 'PUT','enctype'=>'multipart/form-data')) }}
                    @else
                        {{ Form::open(array('route' => 'convictnotarrestinfo.store','enctype'=>'multipart/form-data')) }}
                    @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @if(@$parentData->attach !='')
                                      <a href="{!! url('public/uploads/convictnotarrestinfoattach/'.$parentData->attach) !!}" download class="btn btn-primary">Download</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="convict_box">
                            ...
                            <div class="panel-body convict_row_element">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="exampleInput">Description<span class="validateRq">*</span></label>
                                            {!! Form::textarea('details[description][]', $row->description, $attributes = array('class'=>'form-control','placeholder'=>'Enter Description','cols'=>'30','rows'=>'2','required'=>'required')) !!}
                                        </div>
                                    </div>
    ...
    <div class="panel-body convict_row_element">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <label for="exampleInput">Description<span class="validateRq">*</span></label>
                    {!! Form::textarea('details[description][]', '', $attributes = array('class'=>'form-control','placeholder'=>'Enter Description','cols'=>'30','rows'=>'2', 'required'=>'required')) !!}
                </div>
            </div>
            <div class="col-md-2 text-right">
                <span class="badge deleteVictims" style="background: red;margin-top: 25px;cursor: pointer;">X</span>
